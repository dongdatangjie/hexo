...
var backLayer,loadingLayer,background,hero,stageLayer;
var stageSpeed = 0,hero,layers = 0,layersText,hpText;
var MOVE_STEP = 2, STAGE_STEP = 1;
var g=0.08;
var stageSpeed = 0;
init(20,"mylegend",320,480,main);
function main(){
    //游戏全屏显示居中
 ...
 */
function wallInit(){
    var bitmapDataUp = new LBitmapData(loadData["floor3"]);
    var bitmapUp;
