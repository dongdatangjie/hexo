...
function gameInit(result){
	...
	var bitmapData = new LBitmapData(loadData["player"]);
...
function setObject(){
	...
	if(frames % 50 == 0){
		...
		var obj = new BulletCtrl({
			...
			bulletIndex:bulletIndex,bitmapData:new LBitmapData(loadData["item"+bulletIndex])
		});
	...
	if(ctrlObject["frames"] == frames){
		...
		bitmapData = new LBitmapData(loadData[ctrlObject.img]);
		var enemy;
